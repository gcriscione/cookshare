<template>
    <main>
        <button class="btn btn-secondary mb-4" @click="this.showDiv = !this.showDiv">
        ...
        <div v-show="showDiv" class="container">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="ingredients" v-model="newRecipe.ingredients" rows="3" maxlength="300" required></textarea>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="tags" v-model="newRecipe.tags" maxlength="100" required />
